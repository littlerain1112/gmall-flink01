...
public class Test01_Jump {
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<JSONObject> wmDS = jsonObj.assignTimestampsAndWatermarks(WatermarkStrategy
        ...
        KeyedStream<JSONObject, String> keyedStream = wmDS.keyBy(j -> j.getJSONObject("common").getString("mid"));
        ...
        DataStream<JSONObject> sideOutput = selectDS.getSideOutput(timeOut);
        DataStream<JSONObject> unionDS = selectDS.union(sideOutput);

        unionDS.print();
        unionDS.map(j -> j.toJSONString())
