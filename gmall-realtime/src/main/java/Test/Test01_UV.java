...
public class Test01_UV {
    public static void main(String[] args) throws Exception {
        ...
        KeyedStream<JSONObject, String> keyedStream = jsonObj.keyBy(jsonObject ->
        ...
        SingleOutputStreamOperator<JSONObject> filter = keyedStream.filter(new RichFilterFunction<JSONObject>() {
            ...
            public boolean filter(JSONObject jsonObject) throws Exception {
                ...
                if (lastPageId == null || lastPageId.equals("")) {
                    ...
                    String ts = sdf.format(jsonObject.getLong("ts"));

                    if (value == null || !value.equals(ts)) {
        ...
        filter.map(JSONAware::toJSONString).addSink(MyKafkaUtil.getKafkaSink(""));
